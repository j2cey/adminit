...
export default {
    ...
    methods: {
        ...
        editReportFile(reportfile) {
            ReportFileBus.$emit('edit_reportfile', { reportfile })
        },
        deleteReportFile(reportfile) {
            this.$swal({
                ...
                if(result.value) {
                    ...
                    axios.delete(`/reportfiles/${reportfile.uuid}`)
                        .then(resp => {
                            this.removeReportFileFromList(reportfile)
                        }).catch(error => {
