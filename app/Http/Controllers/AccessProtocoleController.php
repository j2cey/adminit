...
class AccessProtocoleController extends Controller
{
    ...
    {
        $accessprotocole = AccessProtocole::createNew($request->name, $request->status, $request->description);
    ...
    {
        $accessprotocole->updateOne($request->name, $request->status, $request->description);
