...
class AccessProtocoleController extends Controller
{
    ...
    {
        $accessprotocole = AccessProtocole::createNew($request->name, $request->default_port, $request->code, $request->protocole_class, $request->status, $request->description);
    ...
    {
        $accessprotocole->updateOne($request->name, $request->default_port, $request->code, $request->protocole_class, $request->status, $request->description);
