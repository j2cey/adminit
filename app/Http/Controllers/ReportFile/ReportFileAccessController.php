...
class ReportFileAccessController extends Controller
{
    ...
    {
        $reportfileaccess = ReportFileAccess::createNew($request->reportfile, $request->accessaccount, $request->reportserver, $request->accessprotocole, $request->name,$request->port, $request->code, $request->status, $request->description);
    ...
    {
        $reportfileaccess->updateOne($request->reportfile, $request->accessaccount, $request->reportserver, $request->accessprotocole, $request->name,$request->port, $request->code, $request->status, $request->description);
