 ...
 */
class UpdateComparisonTypeRequest extends ComparisonTypeRequest
{
    /**
    ...
    {
        return Auth::user()->can( Permissions::ComparisonType()->update() );
    }
    ...
    {
        return ComparisonType::updateRules($this->comparisontype);
    }
