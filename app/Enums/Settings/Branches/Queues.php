...
class Queues extends SettingNode
{
    public function __construct()
    {
        ...
        $workerbounds->addChild("progression", "1,2,2", "array", "workers bounds pour progression.");
        $workerbounds->addChild("systemlog", "1,2,2", "array", "workers bounds pour systemlog.");
        $workerbounds->addChild("treatmentstartend", "1,1,1", "array", "workers bounds pour treatmentstartend.");
        $workerbounds->addChild("listener", "1,3,3", "array", "workers bounds pour listeners.");
        $workerbounds->addChild("main", "1,3,3", "array", "workers bounds pour main.");
        $workerbounds->addChild("downloadfile", "1,1,3", "array", "workers bounds pour downloadfile.");
        $workerbounds->addChild("importfile", "1,3,3", "array", "workers bounds pour importfile.");
        $workerbounds->addChild("formatfile", "1,5,5", "array", "workers bounds pour formatfile.");
        $workerbounds->addChild("mergefile", "1,3,3", "array", "workers bounds pour mergefile.");
        $workerbounds->addChild("notifyfile", "1,3,3", "array", "workers bounds pour notifyfile.");
    }
}
