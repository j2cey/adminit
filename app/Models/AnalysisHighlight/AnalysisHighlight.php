...
namespace App\Models\AnalysisHighlight;
 ...
 * @property int|null $innerhighlight_id
 *
 * @property Carbon $created_at
 * @property Carbon $updated_at
 * @property IInnerHighlight $innerhighlight
 */
class AnalysisHighlight extends BaseModel implements Auditable
{
    ...
    public static function messagesRules() {
        return [
            ...
            'highlighttype.required' => "Prière de renseigner le Type",
        ];
