        ...
        <div class="container">
            ...
            <div class="tw-bg-white tw-shadow-md tw-rounded tw-px-3 md:tw-px-8 tw-pt-3 md:tw-pt-6 tw-pb-3 md:tw-pb-8 tw-mb-4">
                ...
                <div class="tw-mb-4">
                    ...
                    <search-form
                        group="report-search"
                        url="<?php echo e(route('reports.fetch')); ?>"
                        :params="{
                            search: '',
                            ...
                            <div class="tw-col-span-4 md:tw-col-span-2">
                                ...
                                <div class="tw-inline-flex">
                                    <div class="tw-relative">
                                        ...
                                        >
                                            <option
                                                v-for="reporttype in <?php echo e($reporttypes); ?>"
                                                :value="reporttype.id"
                            ...
                            <div class="tw-col-span-4 md:tw-col-span-2">
                                ...
                                <div class="tw-inline-flex">
                                    <div class="tw-relative">
                                        ...
                                        >
                                            <option
                                                v-for="status in <?php echo e($statuses); ?>"
                                                :value="status.id"
                                            >{{ status.name }}</option>
                                        </select>
                                        <select-angle></select-angle>
...
<?php echo $__env->make('app', ['page_title' => "Reports"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/adminit/resources/views/reports/index.blade.php ENDPATH**/ ?>