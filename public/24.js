...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    _analysishighlightBus__WEBPACK_IMPORTED_MODULE_1__["default"].$on('create_new_highlight', function (_ref) {
      var analysisrule = _ref.analysisrule,
          when_rule_result_is = _ref.when_rule_result_is;

      if (_this.analysisrule.uuid === analysisrule.uuid && _this.when_rule_result_is === when_rule_result_is) {
        console.log('create_new_highlight received: ', analysisrule, when_rule_result_is);
        _this.editing = false;
        _this.highlight = new Highlight({});
        _this.highlight.analysis_rule_id = analysisrule.id;
        _this.highlight.when_rule_result_is = when_rule_result_is;
        _this.when_rule_result_is = when_rule_result_is;
  ...
  methods: {
    ...
    createHighlight: function createHighlight() {
      ...
      console.log('form to post: ', this.highlight.analysis_rule_id, this.when_rule_result_is_prop, this.highlightForm);
      this.highlightForm.post('/analysishighlights').then(function (highlight) {
        ...
        _this3.$swal({
          ...
          _analysishighlightBus__WEBPACK_IMPORTED_MODULE_1__["default"].$emit('highlight_created', highlight);
    ...
    updateHighlight: function updateHighlight() {
      ...
      this.loading = true;
      this.highlightForm.put("/analysishighlights/".concat(this.highlightId), undefined).then(function (updhighlight) {
        _this4.loading = false;
        _analysishighlightBus__WEBPACK_IMPORTED_MODULE_1__["default"].$emit('highlight_updated', updhighlight);
        $('#addUpdateHighlight').modal('hide');
      })["catch"](function (error) {
        _this4.loading = false;
      });
