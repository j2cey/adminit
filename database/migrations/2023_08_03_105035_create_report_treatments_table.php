...
class CreateReportTreatmentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->string('hasreporttreatments_type')->nullable()->comment('referenced ReportTreatmentResult owner s model (class name)');
            $table->bigInteger('hasreporttreatments_id')->nullable()->comment('referenced ReportTreatmentResult owner s model id (object id)');
